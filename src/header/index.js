      ...
      <div className={classes.root}>
        ...
        >
          ...
          <MenuList>
            ...
            <MenuItem component={Link} to="/employeeapprisal">
                <ListItemIcon>
                  <InboxIcon />
                </ListItemIcon>
                  <ListItemText primary="EmployeeApprisal" />
            </MenuItem>

            <MenuItem component={Link} to="/interview">
                <ListItemIcon>
                  <InboxIcon />
                </ListItemIcon>
            ...
            <MenuItem component={Link} to="/onlinetest">
                <ListItemIcon>
                  <InboxIcon />
                </ListItemIcon>
